...
let memoriaBloco = ‘’;
if (paciente) {
memoriaBloco = `\n━━━ MEMÓRIA DO PACIENTE ━━━ • Nome: ${paciente.nome || 'Não informado'} • Primeira vez: ${paciente.primeira_vez ? 'Sim' : `Não (${paciente.total_conversas} conversa(s))`} • Consultório preferido: ${paciente.consultorio_preferido || 'Não informado'} • Última queixa: ${paciente.ultima_queixa || 'Não informada'} • Procedimentos de interesse: ${paciente.procedimentos_interesse || 'Nenhum'} • Última conversa: ${paciente.ultima_conversa || 'Agora'} USE estas informações para personalizar o atendimento.`;
}
...
system: `Extraia dados do paciente. Responda APENAS em JSON válido: {"nome":"primeiro nome ou null","consultorio_preferido":"Copacabana ou Barra da Tijuca ou null","ultima_queixa":"em até 10 palavras ou null","procedimentos_interesse":"separados por vírgula ou null"}`,
